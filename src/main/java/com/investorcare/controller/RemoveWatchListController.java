 ...
 * @author quyt2
 */
public class RemoveWatchListController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (watchListIdStr != null && !watchListIdStr.isEmpty()) {
                int watchListId = Integer.parseInt(watchListIdStr);

                com.investorcare.dao.WatchListDAO dao = new com.investorcare.dao.WatchListDAO();
