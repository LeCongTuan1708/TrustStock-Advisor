...
@WebServlet(name = "ShowViewAlertController", urlPatterns = {"/ShowViewAlertController"})
public class ShowViewAlertController extends HttpServlet {
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            // Lấy danh sách tài sản (Assets) để hiển thị tên thay vì chỉ ID
            ...
            request.getRequestDispatcher("viewAlert.jsp").forward(request, response);
        } catch (Exception e) {
            e.printStackTrace();
