 ...
 * @author quyt2
 */
public class RemoveWatchListItemController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (itemIdStr != null && !itemIdStr.isEmpty()) {
                ...
                boolean check = dao.deleteWatchListItem(itemId);

                if (check && watchListIdStr != null) {
                    url = "MainController?action=watchlist-item&selectedId=" + watchListIdStr;
                }
            }
        } catch (Exception e) {
            e.printStackTrace();
